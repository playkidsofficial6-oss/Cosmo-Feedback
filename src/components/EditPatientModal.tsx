...
export const EditPatientModal: React.FC<EditPatientModalProps> = ({ patient, onClose, onSuccess }) => {
  ...
  const onSubmit = async (data: EditPatientFormData) => {
    ...
    try {
      ...
      await api.put(`/patients/${patient.id}`, updateData);
      onSuccess();
    } catch (error) {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-box" style={{ maxWidth: '700px', maxHeight: '90vh', overflowY: 'auto', width: "100%" }} onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-sub">Update patient information</div>
